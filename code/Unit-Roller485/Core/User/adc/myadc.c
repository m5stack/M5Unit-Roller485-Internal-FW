...
void MyAdcProcess(void)
{
    ...
    internal_temp = __HAL_ADC_CALC_TEMPERATURE(__HAL_ADC_CALC_VREFANALOG_VOLTAGE(adc1_convbuf[5], ADC_RESOLUTION_12B),
                                               adc1_convbuf[4], ADC_RESOLUTION_12B);
...
uint16_t MyAdcGetVal(uint8_t adc_hw, uint8_t channel)
{
    ...
    switch (adc_hw) {
        case 1: {
            switch (channel) {
                case 1: {
                    adc_val = adc1_convbuf[0];
                    break;
                }
                case 2: {
                    adc_val = adc1_convbuf[1];
                    break;
                }
                case 3: {
                    adc_val = adc1_convbuf[2];
                    break;
                }
                case 4: {
                    adc_val = adc1_convbuf[3];
                    break;
                }
            }
            break;
        ...
        case 2: {
            switch (channel) {
                case 1: {
                    adc_val = adc2_convbuf[0];
                    break;
                }
                case 2: {
                    adc_val = adc2_convbuf[1];
                    break;
                }
                case 3: {
                    adc_val = adc2_convbuf[2];
                    break;
                }
                case 4: {
                    adc_val = adc2_convbuf[3];
                    break;
                }
            }
        }
